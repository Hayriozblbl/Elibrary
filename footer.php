        ...
        <footer class="site-footer">
            <div class="container">
                <div id="footer-widgets">
                    <div class="row">
                        <div class="col-md-9 col-sm-9 widget-container">
                            <div id="text-2" class="widget widget_text">
                                ...
                                <address>
                                    <div class="info">
                                        ...
                                        <span><?php echo $ayarcek['ayar_adres']; ?></span>
                                    </div>
                                    <div class="info">
                                        <i class="fa fa-envelope"></i>
                                        <span><a href=""><?php echo $ayarcek['ayar_mail']; ?></a></span>
                                    </div>
                                    <div class="info">
                                        <i class="fa fa-phone"></i>
                                        <span><a href=""><?php echo $ayarcek['ayar_tel']; ?></a></span>
                                    </div>
                                </address>
                            </div>
                        </div>
                        <div class="col-md-2 col-sm-6 widget-right">
                ...
                <div class="container">
                    <div class="row">
                        <div class="footer-text col-md-3">
                            <p>Nuh Naci Yazgan Üniversitesi</a></p>
                        </div>
