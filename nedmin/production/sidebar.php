    ...
    <h3> <?php 
     ...
     <ul class="nav side-menu">
       <li><a href="index.php"><i class="fa fa-home"></i> Anasayfa<span class="label label-success pull-right"></span></a></li>
        ...
        <!--  <li><a href="slider-bilgi.php"><i class="fa fa-image"></i> Slider İşlemleri<span class="label label-success pull-right"></span></a></li>
 ...
 -->
         ...
         <li><a href="icerik.php"><i class="fa fa-comments-o"></i> Konferans<span class="label label-success pull-right"></span></a></li>
          <li><a href="dergi-icerik.php"><i class="fa fa-file-text"></i>Dergi<span class="label label-success pull-right"></span></a></li>
          <li><a href="makale.php"><i class="fa fa-archive"></i>Makale<span class="label label-success pull-right"></span></a></li>
<!--
         ...
         <li><a href="video.php"><i class="fa fa-video-camera"></i> Video Galeri<span class="label label-success pull-right"></span></a></li>
 -->
